...
def getGeoDataframe(geoJsonFilename):
    ...
    # Note: names of neighborhoods don't quite line up between datasets (i.e. between geographic boundaries and 
    # Zealty sold data). Some seem to be due to capitalization or formatting issues (e.g. Fraserview VE vs 
    # FraserView VE, Yale vs Yale - Dogwood Valley) while some of the islands seem to be missing in the scraped 
    #dataset (e.g. Gabriola island). Conversion below harmonizes names so that data can be correctly lined up
...
if __name__ == '__main__':
    ...
    #Get geography data
    #Note on source of data: 
    #Original data from here: https://vadimmarusin.carto.com/tables/bc_condo_prices_by_neighbourhood/public
    #Original data modified using Google MyMaps here: https://www.google.com/maps/d/u/0/edit?hl=en&mid=1GH5NiZg0KxC7O9gBG40dlvKDGBRuFVE&ll=49.326468086686845%2C-123.09479915231066&z=15
